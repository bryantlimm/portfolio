...
import { Code, Palette, HeartHandshake } from 'lucide-react';

// ── Moved outside HomeSkills so it's not recreated on every render ──
            ...
            <motion.div
              ...
              style={{
                backgroundColor:
                  ...
                  color === 'text-purple-600' ? '#9333ea' : '#16a34a'
              }}
...
const HomeSkills = () => {
  ...
  const devSkills     = skills.filter(s => s.type === 'development' || !s.type);
